...
summary: We show that the highest redshift galaxies detected with the James Webb Space
  Telescope, will have a highly skewed distribution due to galaxy clustering, which
  can be quantified through an effect known as **cosmic variance**.
tags:
- Galaxies
- Cosmology
