---
# Kept on the front page regardless of date; see layouts/home.html.
pinned: true
title: Theorist or observer?
summary: Many people ask me if I am a theorist or an observer, and the answer is always
  a bit of a mess. Here are my thoughts on it, being both and maybe something different.
...
My first series of papers in graduate school (on [galaxy formation histories](/projects/mangrove/) and [environments](/projects/gnn-environment/)) were all done starting from simulation data, which shaped the early talks I gave to scientific audiences, and therefore this view of me as a theorist. 
...
The majority of my time at Princeton and at the University of Copenhagen has been focused on observations. My first paper was on _empirically_ [classifying gamma-ray bursts](/projects/tsne-grb/), then I worked on measuring and forecasting [cosmic variance for JWST](/projects/high-z-jwst/), writing proposals for JWST, calibrating point-spread functions for [COSMOS2020](/projects/cosmos/), then on observing [neutrinos with IceCube](/projects/neutrino-ml/). This work has continued while at Princeton, where I have been CoI on a couple of succesful JWST proposals, and thought some more about [cosmic variance](/projects/most-massive-jwst/). 

However, my biggest claim to being an observer has come from the times I have actually physically been observing (which I where the picture at the top of the post is from), as well as my +3 year-involvement in the engineering/commissioning teams for the Prime Focus Spectrograph (PFS) and its auxilliary telescope, the [Subaru Night Sky Spectrograph (SuNSS)](/projects/sunss-airglow/).
